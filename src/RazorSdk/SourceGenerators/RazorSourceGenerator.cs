        ...
        public void Initialize(IncrementalGeneratorInitializationContext context)
        {
            ...
            var generatedDeclarationCode = componentFiles
                ...
                .WithLambdaComparer(static (a, b) =>
                {
                    ...
                    return a.Left.Equals(b.Left) && a.Right.EqualsIgnoringSupression(b.Right);
                },
                static (pair) =>
                {
                    var (left, _) = pair;
            ...
            var tagHelpersFromReferences = context.CompilationProvider
                ...
                .WithLambdaComparer(static (a, b) =>
                {
                    var ((compilationA, _), razorSourceGeneratorOptionsA) = a;
                    var ((compilationB, hasRazorFilesB), razorSourceGeneratorOptionsB) = b;
                    ...
                    return razorSourceGeneratorOptionsA.EqualsIgnoringSupression(razorSourceGeneratorOptionsB);
                },
                static item =>
                {
                    var (left, _) = item;
